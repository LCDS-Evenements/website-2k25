...
export const all: Artist[] = [
  ...
  { name: "Future Rupture", hours: "Sam | 20:30", musicType: "Pop Rock / Electro", image: "/artists/future-rupture.svg", link: "https://www.youtube.com/channel/UCV4biCp_ELQdWEIvuHVkA6Q", type: "big", comingSoon: false },
  { name: "Hanaka", hours: "Sam | 16:30", musicType: "Techno melodic", image: "/artists/hanaka.svg", link: "https://www.instagram.com/hanaka____/", type: "small", imageClassName: "h-[100%] w-[70%]", comingSoon: false },
  { name: "Alura", hours: "Ven | 03:00", musicType: "Techno / Trans / Hypnotic", image: "/artists/alura.svg", link: "https://soundcloud.com/laura-quintard", type: "small", imageClassName: "h-[100%] w-1/2", comingSoon: false },
  { name: "Oxygen", hours: "Ven | 19:00", musicType: "Reggae", image: "/artists/supa-mana.svg", link: "aldkjalksjd", type: "big", comingSoon: true },
  { name: "Gohô", hours: "Ven | 00:00", musicType: "Electro / Dub", image: "/artists/gohodub.svg", link: "https://www.youtube.com/@gohodub", type: "small", imageClassName: "h-[100%] w-1/2", comingSoon: false },
...
export const allResponsive: Artist[] = [
  ...
  { name: "Future Rupture", hours: "Sam | 20:30", musicType: "Pop Rock / Electro", image: "/artists/future-rupture.svg", link: "aldkjalksjd", type: "big", imageClassName: "h-[85%] w-3/4", comingSoon: false },
  { name: "Hanaka", hours: "Sam | 16:30", musicType: "Techno melodic", image: "/artists/hanaka.svg", link: "https://www.instagram.com/hanaka____/", type: "small", imageClassName: "h-[100%] w-1/2", comingSoon: false },
  { name: "Alura", hours: "Ven | 03:00", musicType: "Techno / Trans / Hypnotic", image: "/artists/alura.svg", link: "https://soundcloud.com/laura-quintard", type: "small", imageClassName: "h-[100%] w-3/4", comingSoon: false },
  { name: "Gohô", hours: "Ven | 00:00", musicType: "Electro / Dub", image: "/artists/gohodub.svg", link: "https://www.youtube.com/@gohodub", type: "big", comingSoon: false, imageClassName: "h-[100%] w-[60%]" },
  { name: "Supa Mana", hours: "Ven | 19:00", musicType: "Reggae", image: "/artists/supa-mana.svg", link: "aldkjalksjd", type: "small", imageClassName: "h-[100%] w-1/2", comingSoon: true },
  { name: "Supa Mana", hours: "Ven | 19:00", musicType: "Reggae", image: "/artists/supa-mana.svg", link: "aldkjalksjd", type: "small", imageClassName: "h-[100%] w-1/2", comingSoon: true },
]